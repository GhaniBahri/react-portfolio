  ...
  return (
    <div className='fixed right-5 top-28 z-10 overflow-visible w-fit'>
        ...
        <div className=' flex flex-col w-full justify-center  items-center gap-6 mt-12 transition-opacity duration-700 ease-in ' id='contact'>
            ...
            <a href="https://github.com/GhaniBahri" className='w-12 h-12 border-2 border-black bg-white rounded-md shadow-[0_0_4px_2px_rgba(0,0,0,40%)] p-2 ml-auto'>
                <img className='w-full h-full' src={github} width={10} height={10} alt='as' />
            </a>
            <a href="https://linkedin.com/in/abdelghani-bahri-0a190a159" className='w-12 h-12 border-2 border-black bg-white rounded-md shadow-[0_0_4px_2px_rgba(0,0,0,40%)] p-2 ml-auto'>
