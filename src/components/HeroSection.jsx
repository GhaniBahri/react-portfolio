  ...
  return (
    <section className='w-full flex flex-col items-center justify-center bg-transparent text-white text-center relative overflow-hidden z-0'>
      ...
      <div className='w-full md:selection:w-1/2 mx-auto flex flex-col items-center justify-start gap-2 px-8 mt-24 z-20'>
          ...
          <h1 className={styles.textOutline+' text-7xl  md:text-9xl w-full mt-12 mb-2 text-transparent font-londrina '}>ABDELGHANI BAHRI </h1>
          <h2 className='font-bold w-full text-3 xl text-white '>Front-end Developer</h2>
      ...
      <div className='absolute top-10 left-0 hidden md:block galaxy1'>
      ...
      <div className=' p-8 bg-transparent text-left w-11/12 mt-20 z-20'>
